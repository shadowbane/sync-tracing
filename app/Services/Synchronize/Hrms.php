        ...
        $this->query = $this->db->select("
            SELECT
               ...
               'Yayasan' as unit,
                ...
                ( SELECT COUNT( id ) FROM employee_vaccinations WHERE eb.uuid = employee_vaccinations.detail_uuid AND deleted_at IS NULL ORDER BY id DESC LIMIT 1 ) AS vac_count
            FROM
